            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link
                  ...
                  href="/raves"
                ><div className="cursor-pointer inline-flex items-center px-4 py-2 mt-2 font-medium text-white transition duration-500 ease-in-out transform bg-transparent rounded-lg text-md md:mt-0 md:ml-4 bg-gray-900">
